...
The live API also requires the Emma app request signature on every call — `User-Agent: Emma/999 CFNetwork iOS`, `Origin: https://web.emma-app.com`, `Referer: https://web.emma-app.com/`:
